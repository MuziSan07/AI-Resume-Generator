...
# Page configuration
st.set_page_config(
    page_title="ATS Resume Generator - GenCodeLabs",
    page_icon="📄",
    layout="wide"
)
...
try:
    import base64
    logo_path = r"D:\AI Projects For Portfolio\Company Logo.jpeg"
    ...
    try:
        ...
        st.markdown(f"""
            <div class="company-header">
                <img src="data:image/jpeg;base64,{logo_data}" class="company-logo" alt="GenCodeLabs Logo">
                <div class="company-link">
                    <a href="https://www.gencodelabs.com" target="_blank">www.gencodelabs.com</a>
                </div>
            </div>
        """, unsafe_allow_html=True)
    except FileNotFoundError:
        # If logo file not found, show text header
        st.markdown("""
            <div class="company-header">
                <h2 style="color: #1f77b4; margin: 0;">GenCodeLabs</h2>
                <div class="company-link">
                    <a href="https://www.gencodelabs.com" target="_blank">www.gencodelabs.com</a>
                </div>
            </div>
            ...
            try:
                ...
                resume_prompt = PromptTemplate(
                    input_variables=[
                        ...
                        "skills", "work_experience", "projects", "certifications", "achievements"
                    ],
...
(Only include links that are provided. Format as: link1 | link2 | link3)
...
(Only include if certifications are provided)

ACHIEVEMENTS
List achievements from: {achievements}
Format as bullet points:
• Achievement 1 with specific metrics or recognition
• Achievement 2 with impact
• Achievement 3 with results
(Only include if achievements are provided)
